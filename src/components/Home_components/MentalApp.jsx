...
function MentalApp(){
    return(<div class ="container-fluid topContainer">
        <div class="row ">
        <div class="col-lg-6">
          <h1 class="big-heading" >Lorem Ipsum. Curabitur ut magna volutpa</h1>
          ...
          <Link class="btn btn-dark btn-lg " to="/book-appointment">
          Book an Appiontment
          </Link>
          <Link class="btn btn-primary btn-lg " to="/aboutus">
          Learn More
          </Link>
        </div>

        <div class="col-lg-6">
          <img src={psychiatristImg} alt="img" />
        </div>
      </div>
    </div>)
}
